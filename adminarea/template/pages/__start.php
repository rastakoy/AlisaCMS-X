...
<fieldset style="background-color:#A9C9A7; padding-top:0px;">
	...
	<b style="text-transform:uppercase;padding-left:5px;padding-right:5px;">Настройка блоков сайта</b></legend>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			...
			<button onclick="importExternalData()">Настройка</button></td>
		</tr>
		<? }} ?>
		<tr>
			<td height="30" width="" style="padding-top:5px;"><button onclick="addSiteBlock()">Добавить блок</button></td>
...
function addSiteBlock(){
	document.getElementById("popup_title").innerHTML = "Перечень блоков для добавления";
	__popup({"width":"500"});
}
</script>
<!-- =============================== -->
...
<!-- =============================== -->
<div style="line-height:25px; margin-top:15px;margin-right:15px;float:left;" id="">
	<b style="text-transform:uppercase;">Настройка меню</b>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<? }} ?>
		<tr>
			<td height="30" width="" style="padding-top:5px;"><button>Добавить меню</button></td>
			<td class="" width="30">&nbsp;</td>
		</tr>
	</table>
	</div>
...
<div style="line-height:25px; margin-top:15px;margin-right:15px;float:left;" id="gsAll">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			<td class="tdGlobalSettings" width="300">Звуковое уведомление о покупке</td>
