...
?>
	...
	<div class="div_myitemname" style="padding-top: 0px;height:<?=$divHeight?>px;">
		<table id="folder_1" cellpadding="0" cellspacing="0" border="0" width="100%"><tr>
			<td height="<?=$tdHeight?>" width="20"><img src="<?=$GLOBALS['adminBase']?>/template/images/green/myitemname_popup/checkbox.gif" id="imgcheck_1" width="16" height="16" border="0" class="items_select_all" style="cursor:pointer" onclick="toggle_item_check(1)"></td>
			<td height="<?=$tdHeight?>" width="20"><a href="javascript:" title="Отображение группы"><img
...
id="prm_?action=editItem,option=<?=$params['option']?>,parents=<?=$params['parents']?>,itemId=<?=$item['id']?>">
	<div class="div_myitemname" style="padding-top: 0px;height:<?=$divHeight?>px;<? if($item['tmp']=='1'){ 
