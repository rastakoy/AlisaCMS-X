		...
		<a onclick="getData('/adminarea/filters/editfilter/<?=$filterParent['id']?>/')"
		href="javascript:" id="edit_folder_cat_button">Свойства шаблона</a>
		<a onclick="getData('/adminarea/filters/')" href="javascript:" id="add_folder_to_cat_button">Просмотр фильтров</a>
