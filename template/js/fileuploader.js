...
function startFileUploader(){
	...
	var exit = true;
	//alert(typeof currentNoticeId);
	var params = false;
	if(typeof currentNoticeId!='undefined'){
		paramss = {currentNotice: currentNoticeId};
	}else if(typeof currentPageId!='undefined'){
		paramss = {currentPage: currentPageId};
	}else if(typeof currentCatalogItemId!='undefined'){
		paramss = {	
			currentCatalogItem: currentCatalogItemId,
			tableName: 'catalog'
		};
	}else if(typeof currentItemId!='undefined'){
		paramss = {
			"externalId": currentItemId,
			"table": currentOptionName
		}
	}
	...
	var uploader = new qq.FileUploader({
		...
		onComplete: function(id, fileName, responseJSON){
			...
			insertImgModule(responseJSON.newimgid);
